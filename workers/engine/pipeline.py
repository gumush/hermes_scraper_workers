...
from workers.engine.date_converter import DateConverter
from workers.engine.date_filter import DateFilter
...
class MongoDBTask(SyncTask):
    ...
    def _ensure_storage(self):
        if self._storage is None:
            from workers.engine.data_storage import MongoDBStorage
...
class JSONTask(SyncTask):
    ...
    def run(self, reviews: Dict[str, Dict[str, Any]], place_id: str) -> None:
        from workers.engine.data_storage import JSONStorage
